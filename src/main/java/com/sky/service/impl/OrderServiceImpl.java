...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
     ...
     * @return
     */
    public Integer payment(HttpServletResponse response) throws Exception {
        // 当前登录用户id
        Long userId = BaseContext.getCurrentId();
        User user = userMapper.getById(userId);
        String number = orderMapper.getnumber(userId);
        paySuccess(number,response);
        return 0;
    }
     ...
     * @param outTradeNo
     */
    public void paySuccess(String outTradeNo, HttpServletResponse response) throws Exception {
        // 当前登录用户id
        Long userId = BaseContext.getCurrentId();
...
//        orderMapper.update(ordersDB);
    ...
    public PageResult pageQuery4User(int pageNum, int pageSize, Integer status) {
        // 设置分页
        Page<Orders> page = Page.of(pageNum, pageSize);;
        page.addOrder(new OrderItem("order_time",false));
        lambdaQuery()
    ...
    public PageResult conditionSearch(OrdersPageQueryDTO ordersPageQueryDTO) {
        ...
        lambdaQuery()
                ...
                .eq(beginTime != null, Orders::getOrderTime, beginTime)
                .eq(endTime != null, Orders::getOrderTime, endTime)
                .page(page);
